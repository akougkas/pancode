import { getOAuthProviders } from "@pancode/pi-ai/oauth";
import { Container, type Focusable, getEditorKeybindings, Input, Spacer, Text, type TUI } from "@pancode/pi-tui";
...
export class LoginDialogComponent extends Container implements Focusable {
	...
	constructor(
		...
		const providerInfo = getOAuthProviders().find((p: any) => p.id === providerId);
