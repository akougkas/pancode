...
import { Agent, type AgentMessage, type ThinkingLevel } from "@pancode/pi-agent-core";
import type { Message, Model } from "@pancode/pi-ai";
 ...
 *
 * // With explicit model
 * import { getModel } from '@pancode/pi-ai';
 * const { session } = await createAgentSession({
